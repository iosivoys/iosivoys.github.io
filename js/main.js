...
let arr = [
    ...
    },
    {
        ...
        percent: 2.5,
        disc: `Пожертвовать от чистого серсдца`,
        h2ID: 'Four'
    },
    {
        forwhat: 'Капитал',
        percent: 29.7,
        disc: `Сумма благ в виде материальных, интеллектуальных и финансовых средств, используемых в качестве ресурса в целях получения прибыли.`,
        h2ID: 'Five'
    },
    {
        forwhat: 'Мечта',
